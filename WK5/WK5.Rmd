...
```{r}
Londonborough <- st_read("D:/UCL_CODE/CASA0005/data/WK5/statistical-gis-boundaries-london/statistical-gis-boundaries-london/ESRI/London_Borough_Excluding_MHW.shp") %>%
  st_transform(., 27700)

OSM <- st_read("D:/UCL_CODE/CASA0005/data/WK5/greater-london-latest-free.shp/gis_osm_pois_a_free_1.shp") %>%
  st_transform(., 27700) %>%
  dplyr::filter(fclass == 'hotel')

Worldcities <- st_read("D:/UCL_CODE/CASA0005/data/WK5/World_Cities/World_Cities.shp") %>%
  st_transform(., 27700)

UK_outline <- st_read("D:/UCL_CODE/CASA0005/data/WK5/gadm41_GBR_shp/gadm41_GBR_0.shp") %>%
  st_transform(., 27700)

Airbnb <- read_csv("D:/UCL_CODE/CASA0005/data/WK5/listings.csv") %>%
