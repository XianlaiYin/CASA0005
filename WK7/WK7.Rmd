...
```{r read data}
LondonWards <- st_read("D:/UCL_CODE/CASA0005/data/WK7/London-wards-2018/London-wards-2018_ESRI/London_Ward.shp") %>%
  st_transform(.,27700)

BluePlaques <- st_read("https://s3.eu-west-2.amazonaws.com/openplaques/open-plaques-london-2018-04-08.geojson") %>%
  st_transform(.,27700)

LondonWardsMerged <- st_read("D:/UCL_CODE/CASA0005/data/WK7/london_new/ESRI/London_Ward_CityMerged.shp") %>%
  st_transform(.,27700)
